      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="flex sm:flex-row flex-wrap justify-between border-b border-gray-700 pb-8 gap-8">
          ...
          <div className="flex-1 min-w-[200px]">
            <h2 className="md:text-xl font-bold mb-3 text-white">
              Auction Central
            </h2>
            <ul className="space-y-1 text-gray-300">
              <li className="hover:text-white transition text-sm md:text-base">
                Live Auctions
              </li>
              <li className="hover:text-white transition text-sm md:text-base">
                Past Auctions
          ...
          {/* Section 2 */}
          <div className="flex-1 min-w-[200px]">
            <h2 className="md:text-xl font-semibold mb-3 text-white ">
              About Us
            </h2>
            <ul className="space-y-1 text-gray-300">
              <li className="hover:text-white transition text-sm md:text-base">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mt-6 text-gray-400 text-sm">
          ...
          <p>
            Designed by <span className="font-semibold">Suprabhat Maiti</span>
          </p>
        </div>
      </div>
    </footer>
